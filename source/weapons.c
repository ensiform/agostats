...
matchlog_weapon_table MATCHLOG_WEAPON_TABLE[] = {
	...
	"DARTGUN"					, W_DARTGUN					    ,
	"DISEASE"					, W_DISEASE                     ,
	"FAILED_OPERATION"			, W_FAILED_OPERATION		    ,
	"FALLING"					, W_FALLING					    ,
